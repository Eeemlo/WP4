...
<main>
    ...
    <!--WEBBPAKET LONG-->
    <section class="web-packages-long optimization" id="optimization">
            ...
            foreach ($pages as $post):
                ...
                ?>
                    <article class="service-item">
                        ...
                        <h3><?php the_title(); ?></h3>
                            <p><?php the_content(); ?></p>
                            <a href="#optimization-consultation" class="button btn-shadow">Boka konsultation <i
    ...
    <section class="processSection">
        ...
        $page = get_page_by_path('webbanalys-process');  // Ändra slug till den sida som innehåller formuläret
        if ($page) :
...
<section class="web-consultation" id="optimization-consultation">
    <?php
    // Hämta sidan som innehåller innehållet, t.ex. "process"
    $page = get_page_by_path('konsultation-webbanalys');  // Ändra slug till den sida som innehåller formuläret
    if ($page) :
    ?>
        <div class="processText" id="processText">
            <?php
