...
<main>
    ...
    <!--WEBBPAKET LONG-->
    <section class="web-packages-long accessability" id="hours">
                ...
                ?>
                    <article class="service-item">
                        <div class="serviceDescription">
                            <p><?php the_content(); ?></p>
                            <a href="#consultant-consultation" class="button btn-shadow">Boka konsultation <i
...
<section class="web-consultation" id="consultant-consultation">
    <?php
    // Hämta sidan som innehåller innehållet, t.ex. "process"
            ...
            <section class="workExperience">
                <article class="project workItem">
                    <div class="projectDescription">
                        ...
                        <a href="<?php the_permalink(); ?>" class="button btn-shadow"><?php the_title(); ?> <i class="fa-solid fa-arrow-right"></i></a>
                    </div>
                </article>
            </section>
