...
<main>
    ...
    <!--WEBBPAKET LONG-->
    <section class="web-packages-long accessability" id="accessibility">
        <h2>Tillgänglighetsanalys</h2>
        <div class="flexContainer">
            <?php
            // Slugs för sidorna i önskad ordning
            $slugs = array('tillganglighetspaket');
            ...
            foreach ($pages as $post):
                ...
                ?>
                    <article class="service-item">
                        ...
                        <h3><?php the_title(); ?></h3>
                            <p><?php the_content(); ?></p>
                            <a href="#accessibility-consultation" class="button btn-shadow">Boka konsultation <i
    ...
    <section class="processSection">
        ...
        $page = get_page_by_path('tillganglighet-process');  // Ändra slug till den sida som innehåller formuläret
        if ($page) :
...
<svg id="blob3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 420">
    ...
    <div class="gridContainer">
        <?php
        // Slugs för sidorna i önskad ordning
        $slugs = array('hemsida', 'webbanalys', 'konsulttimmar');
