    ...
    <div class="essential-content">
        ...
        if ($page && is_object($page)): ?>
            <article class="service-item">
                    ...
                    <a href="#web-consultation" class="button btn-shadow">Boka konsultation <i class="fa-solid fa-arrow-right"></i></a>
            </article>
        <?php else: ?>
            ...
            foreach ($pages as $post):
                ...
                <article class="service-item">
                    <div class="serviceDescription">
                        <h3><?php the_title(); ?></h3>
                        <p><?php the_content(); ?></p>
                        <a href="#web-consultation" class="button btn-shadow">Boka konsultation <i
                ...
                <section class="workExperience">
                    <article class="project workItem">
                        <div class="projectDescription">
                            ...
                            <a href="<?php the_permalink(); ?>" class="button btn-shadow"><?php the_title(); ?> <i
                                    class="fa-solid fa-arrow-right"></i></a>
                        </div>
                    </article>
                </section>
